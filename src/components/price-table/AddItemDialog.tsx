  ...
  const handleSave = async () => {
    ...
    try {
      ...
      switch (category) {
        ...
        case 'dc_cabling': specData = { ...baseSpec, conductor_material: fv('conductor_material') || null, single_core_price_per_meter: n('single_core_price_per_meter'), size_mm2: n('size_mm2'), '4c_plus_earth_price_per_meter': n('4c_plus_earth_price_per_meter'), inclusion: fv('inclusion') || null, notes: fv('notes') || null }; break;
